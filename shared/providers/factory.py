...
class ProviderFactory:
    ...
    def _get_api_key_for_provider(cls, provider_type: str) -> str:
        ...
        pt = (provider_type or "").strip()

        # Sora: prefer SORA_API_KEY, fallback to OPENAI_API_KEY
        if pt in ("sora", "SORA", "SORA2"):
            return os.getenv("SORA_API_KEY") or os.getenv("OPENAI_API_KEY")
